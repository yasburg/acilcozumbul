...
## Corpus Check
- 437 files · ~413,477 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1864 nodes · 5950 edges · 92 communities (82 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b967b1fd`
...
Cohesion: 0.21
Nodes (27): GET(), rotaKoordinatlari(), POST(), listeDurumuBelirle(), toOzet(), KULLANIMA_ACIK_ILLER, sehirBeklemeMesaji(), sehirKullanimAcikMi() (+19 more)

### Community 1 - "telefonNormalize"
Cohesion: 0.10
Nodes (28): cekiciTalepBolgesineUygunMu(), filtreleCekicilerBolge(), konumCekici(), mockFrom, mockStorageFrom, cekiciTalepSorununaUygunMu(), filtreleCekicilerSorun(), cekiciAcikTalepUygunMu() (+20 more)
...
### Community 4 - "seo.ts"
Cohesion: 0.33
Nodes (7): GET(), POST(), belgeBase64Ayikla(), cekiciBelgeYukle(), IZINLI_MIME, uzanti(), BelgeDurum

### Community 5 - "mappers.ts"
Cohesion: 0.08
Nodes (24): GET(), GET(), Saglik, hizmetBolgeleriFlatten(), getCekiciByDogrulanmisFaturaEposta(), getKrediOdemeById(), kaydetKrediOdeme(), listeleKrediOdemeler() (+16 more)

### Community 6 - "ensureSeedData"
Cohesion: 0.16
Nodes (20): POST(), POST(), GET(), POST(), sonKullanmaAyir(), istemciIpAl(), KREDI_PAKET_TL_LISTESI, KREDI_PAKETLERI (+12 more)

### Community 7 - "ui.tsx"
Cohesion: 0.12
Nodes (33): bolgeOzet(), GET(), POST(), PUT(), GET(), PUT(), POST(), GET() (+25 more)
...
Cohesion: 0.19
Nodes (18): POST(), POST(), DELETE(), cekiciAuthKullaniciSil(), cekiciGirisSifreKontrol(), hesapSilOnayMetniGecerliMi(), cekiciHesapSilOtpDogrula(), CekiciHesapSilOtpKayit (+10 more)
...
Cohesion: 0.16
Nodes (29): GET(), addTalep(), bugunBaslangicIso(), getCekicilerBildirimAdaylari(), getTalepler(), getTaleplerBugun(), getTaleplerMemnuniyetBekleyen(), getTaleplerSayfali() (+21 more)

### Community 14 - "memnuniyet.ts"
Cohesion: 0.29
Nodes (21): POST(), POST(), POST(), IZINLI, POST(), POST(), POST(), SifremiUnuttumPage() (+13 more)
...
Cohesion: 0.09
Nodes (40): GET(), kurulumSifreUygula(), POST(), HaritaNokta, PanelCekiciHarita(), RENK, SehirAdet, cekiciTalepIlIlceyeUygunMu() (+32 more)

### Community 19 - "ensureSeedData"
Cohesion: 0.06
Nodes (21): SmsKaydi, DegerlendirmeSatir, Ozet, BOS_FORM, KampanyaSatir, KullanimSatir, Ozet, Ozet (+13 more)
...
Cohesion: 0.09
Nodes (20): OnayIcerik(), KrediPage(), OdemeOnayPage(), KREDI_ODEME_ADIMLARI, ROZET_ODEME_ADIMLARI, Adim, belgeDurumEtiket(), CekiciDetay (+12 more)

### Community 24 - "page.tsx"
Cohesion: 0.14
Nodes (28): POST(), GET(), baseUrlFrom(), GET(), POST(), GET(), PanelLinkHaritasiPage(), DegerlendirmeRow (+20 more)
...
Cohesion: 0.14
Nodes (35): POST(), POST(), POST(), beniAnimsaOku(), cekiciOturumCookieAyarlari(), bekleyenCekiciGirisOtp(), cekiciGirisOtpDogrula(), cekiciGirisOtpGonder() (+27 more)
...
Cohesion: 0.13
Nodes (30): POST(), GET(), panelKullanici(), POST(), register(), topluSmsIsTablolariVar(), baslatTopluSmsGecmisListe(), aliciSayisi() (+22 more)
...
Cohesion: 0.08
Nodes (30): GpsHttpsBanner(), GpsHttpsBannerProps, KonumIzniYardim(), KonumIzniYardimProps, ADIM_OLAYLARI, ArizaFotografAlani, funnelKaydet(), HizmetVerenSayimAlani (+22 more)
...
Cohesion: 0.28
Nodes (13): POST(), GET(), cekiciPuanOzetleri(), teklifFiyatDegistiMi(), isDemoTalepId(), demoTalepBul(), demoTalepGetir(), demoTeklifSec() (+5 more)
...
Cohesion: 0.22
Nodes (17): POST(), POST(), getTalepById(), updateTalep(), demoKatil(), demoKatilMesaji(), anlasamadiSonrasiIhaleyiSurdur(), cekiciBildirimKrediTutari() (+9 more)
...
Cohesion: 0.23
Nodes (15): GET(), cekiciMusaitMi(), istanbulGunVeDakika(), saatMetniDakika(), cevrimiciJitterFaktor(), cevrimiciJitterUygula(), HIZMET_ETIKET, hizmetVerenEtiket() (+7 more)

### Community 58 - "cerez-onay.ts"
Cohesion: 0.06
Nodes (74): geist, metadata, RootLayout(), viewport, bannerServerSnapshot(), bannerSnapshot(), bannerSubscribe(), CerezOnayBanner() (+66 more)
...
Cohesion: 0.17
Nodes (21): GET(), BOS_FORM, Sablon, GET(), GET(), SMS50_KAYIT_FUNNEL_HARITASI, SMS50_VARYANTLAR, sms50FooterSatirlari() (+13 more)
...
Cohesion: 0.22
Nodes (13): GET(), GET(), GET(), countSmsLog(), getSmsLog(), FunnelOlay, funnelOlaySay(), FunnelOzet (+5 more)

### Community 67 - "route.ts"
Cohesion: 0.15
Nodes (23): GET(), addSmsKaydi(), escapeXml(), GondericiAdiSorguSonuc, logSmsKaydi(), netgsmGondericiAdlariSorgula(), netgsmKimlik(), netgsmOtpSmsGonder() (+15 more)
...
Cohesion: 0.25
Nodes (5): HizmetVerenSayimAlani(), HizmetVerenSayimGostergesi(), HizmetVerenSayimGostergesiProps, useAnimatedNumber(), useHizmetVerenSayim()
...
Cohesion: 0.17
Nodes (22): POST(), GET(), GET(), POST(), panelKullanici(), POST(), panelKullanici(), POST() (+14 more)

### Community 74 - "cekici-puan.ts"
Cohesion: 0.14
Nodes (23): anlasilanIsSay(), cekiciPuanOzeti, computePuanFromTables(), fiyatGarantiPuaniHesapla(), normalizeTeklif(), ozetFromCounts(), tercihPuaniHesapla(), kaybedenTeklifleriIsaretle() (+15 more)

### Community 75 - "admin.ts"
Cohesion: 0.18
Nodes (11): TalepDurum, DavetKoduAyarlari(), DavetKoduDurum, CekiciRotaPanel(), embedDirectionsUrl(), RotaSureleri, useKazananKonumPaylas(), parseJsonYanit() (+3 more)
...
### Community 77 - "cekici-sifre-otp.ts"
Cohesion: 0.83
...
Cohesion: 0.21
Nodes (16): davetKayitBaslangicKredisiFromSonuc(), davetKayitBonusTamamla(), davetKayitHazirla(), DavetKayitSonuc, davetKayitBaslangicKredisi(), davetKoduGecerliMi(), davetKoduNormalize(), davetKoduOner() (+8 more)
...
Cohesion: 0.19
Nodes (14): ADIMLAR, GUVEN, PhoneFirstIcerik(), SSS, kayitFunnelOlayGonder(), kayitFunnelSessionId(), posthogCerezSenkronize(), posthogKampanyaKaydet() (+6 more)

### Community 83 - "page.tsx"
Cohesion: 0.16
Nodes (9): Gorunum, SehirSiralama, DemoDurum, DemoSms, kalanSureFormat(), PanelDemoPage(), SIMULE_ADIMLAR, cekiciPanelOzet (+1 more)

### Community 84 - "getCekiciById"
Cohesion: 0.40
...
### Community 89 - "istanbul-ilceler.ts"
Cohesion: 0.60
Nodes (5): POST(), cekiciAuthRastgeleSifre(), addCekici(), kayitBaslangicKredisi(), kayitKoduBonusTamamla()
...
## Knowledge Gaps
- **359 isolated node(s):** `eslintConfig`, `config`, `nextConfig`, `name`, `version` (+354 more)
...
- **Why does `telefonNormalize()` connect `cekici-email-otp.ts` to `NasilCalisirSerit.tsx`, `gtag.ts`, `ArizaFotografAlani.tsx`, `route.ts`, `toplu-sms-gecmis-db.ts`, `route.ts`, `page.tsx`, `CekiciPanelTabs.tsx`, `memnuniyet.ts`, `musteri-profil.ts`, `MusteriCekiciTakipHarita.tsx`, `sorun-tipleri.ts`, `istanbul-ilceler.ts`, `cerez-onay.ts`, `page.tsx`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `getSupabaseAdmin()` connect `CekiciAyarlarPanel.tsx` to `seo.ts`, `mappers.ts`, `ensureSeedData`, `ui.tsx`, `CekiciPanelTabs.tsx`, `memnuniyet.ts`, `MusteriCekiciTakipHarita.tsx`, `page.tsx`, `kredi-odeme.ts`, `route.ts`, `cekici-email-otp.ts`, `demo-responses.ts`, `NasilCalisirSerit.tsx`, `route.ts`, `cerezAnalitikAktif`, `CerezOnayBanner.tsx`, `seo.ts`, `CerezOnayBanner.tsx`, `davet-panel.ts`, `layout.tsx`, `kampanya-db.ts`, `page.tsx`, `route.ts`, `gtag.ts`, `page.tsx`, `toplu-sms-gecmis-db.ts`, `cekici-puan.ts`, `cekici-sifre-otp.ts`, `mappers.ts`, `route.ts`, `getCekiciById`, `getCurrentCekici`, `istanbul-ilceler.ts`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `Card()` connect `ensureSeedData` to `mappers.ts`, `google-maps.ts`, `db.ts`, `hizmet-veren-sayim.ts`, `hizmet-veren-sayim.ts`, `page.tsx`, `route.ts`, `page.tsx`, `page.tsx`, `kayit-kodu.ts`, `route.ts`, `cerezAnalitikAktif`, `CerezOnayBanner.tsx`, `route.ts`, `fixtures.ts`, `davet-panel.ts`, `admin.ts`, `PanelCekiciHarita.tsx`, `page.tsx`?**
