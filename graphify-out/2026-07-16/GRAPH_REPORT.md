# Graph Report - acilcozumbul  (2026-07-16)

## Corpus Check
- 315 files · ~360,857 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1307 nodes · 4051 edges · 60 communities (54 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f545ca27`
...
Cohesion: 0.08
Nodes (81): POST(), POST(), POST(), GET(), POST(), POST(), POST(), GET() (+73 more)
...
Cohesion: 0.17
Nodes (27): bolgeOzet(), POST(), PUT(), cekiciTalepIlIlceyeUygunMu(), cekiciTalepMenzileUygunMu(), filtreleCekicilerBolge(), ilceEslesir(), normalize() (+19 more)

### Community 6 - "ensureSeedData"
Cohesion: 0.06
Nodes (105): POST(), GET(), rotaKoordinatlari(), POST(), GET(), listeDurumuBelirle(), toOzet(), POST() (+97 more)

### Community 7 - "ui.tsx"
Cohesion: 0.09
Nodes (15): DegerlendirmeSatir, Ozet, BOS_FORM, KampanyaSatir, KullanimSatir, Ozet, Ozet, ArizaFotografAlani() (+7 more)
...
Cohesion: 0.15
Nodes (23): GET(), POST(), GET(), POST(), GET(), PUT(), saatGecerliMi(), PUT() (+15 more)

### Community 11 - "CekiciPanelTabs.tsx"
Cohesion: 0.10
Nodes (21): GirisIcerik(), BolgeAyarlari(), BolgeAyarlariProps, CekiciAyarlarPanel(), DavetKoduAyarlari(), DavetKoduDurum, GUNLER, MusaitlikAyarlari() (+13 more)

### Community 12 - "sms-provider.ts"
Cohesion: 0.09
Nodes (33): GET(), GET(), GET(), GET(), GET(), addSmsKaydi(), getSmsLog(), FunnelOlay (+25 more)
...
Cohesion: 0.13
Nodes (29): GET(), haftaBaslangici(), POST(), GET(), baseUrlFrom(), GET(), POST(), cekiciPuanOzeti (+21 more)
...
Cohesion: 0.09
Nodes (18): Saglik, BolgeApiData, BolgeApiData, gonderimZamani(), onaylanmisSira(), RozetPanelOzet, rozetPanelVerisi, satirFromCekici() (+10 more)

### Community 17 - "CekiciRotaPanel.tsx"
Cohesion: 0.08
Nodes (44): noktaOku(), POST(), GET(), GET(), CekiciRotaPanelProps, embedDirectionsUrl(), googleMapsDirUrl(), MusteriCekiciTakipHarita() (+36 more)

### Community 18 - "MusteriAnaSayfa.tsx"
Cohesion: 0.18
Nodes (20): GpsHttpsBanner(), GpsHttpsBannerProps, KonumIzniYardim(), KonumIzniYardimProps, Step, STEP_SIRA, Spinner(), cihazPlatformu() (+12 more)
...
Cohesion: 0.15
Nodes (20): POST(), GET(), PATCH(), hizmetBolgeleriFlatten(), addTalep(), countCekiciler(), getCekiciByToken(), updateCekiciBelgeDurum() (+12 more)
...
Cohesion: 0.12
Nodes (23): adimAciklamaMetni(), Props, SorunAkisOzeti(), SorunAkisOzetiIcerik(), SorunSecimi(), SorunSecimiProps, TextArea(), CEKICI_ADIMLAR (+15 more)
...
Cohesion: 0.13
Nodes (13): BADGE, Istatistik, PanelData, Tab, TalepOzet, hedefAltYazi(), KonumGuncellemeGostergesi(), renkKaristir() (+5 more)
...
Cohesion: 0.35
Nodes (10): POST(), MusteriAnaSayfa(), sorunAracModeliGerekliMi(), sorunCagriButonEtiketi(), sorunFotografGerekliMi(), sorunMetniOlustur(), sorunTipiBul(), fotografBase64Ayikla() (+2 more)

### Community 52 - "route.ts"
Cohesion: 0.09
Nodes (20): KrediPage(), belgeDurumEtiket(), CekiciDetay, PanelCekiciDetayPage(), BelgeYuklemeAlani(), Props, AVANTAJLAR, CekiciKayitLanding() (+12 more)

### Community 53 - "davet-kayit.ts"
Cohesion: 0.19
Nodes (13): konumCekici(), filtreleCekicilerSorun(), getCekiciById, getCekiciler, sendSms, updateCekici, tumSorunTipIdleri(), cekiciFixture() (+5 more)

### Community 54 - "route.ts"
Cohesion: 0.23
Nodes (6): GET(), GET(), POST(), GET(), POST(), getCurrentCekici()
...
### Community 56 - "Btn"
Cohesion: 0.47
Nodes (7): IZINLI, POST(), POST(), funnelOlayKaydet(), musteriTelCookieDegeri(), ipHash(), istekIp()
...
- **Why does `getSupabaseAdmin()` connect `telefonNormalize` to `demo-oturum.ts`, `getSupabaseAdmin`, `smsBaseUrl`, `ensureSeedData`, `talep-fotograf.ts`, `google-maps.ts`, `sms-provider.ts`, `CekiciAyarlarPanel.tsx`, `memnuniyet.ts`, `sorun-akis-aciklama.ts`, `davet-panel.ts`, `seed.ts`, `Btn`, `route.ts`, `page.tsx`, `page.tsx`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `Card()` connect `ui.tsx` to `page.tsx`, `NasilCalisirSerit.tsx`, `CekiciPanelTabs.tsx`, `db.ts`, `hizmet-veren-sayim.ts`, `CekiciRotaPanel.tsx`, `MusteriAnaSayfa.tsx`, `page.tsx`, `route.ts`, `davet-panel.ts`, `MobileShell.tsx`, `NasilCalisirSerit.tsx`, `page.tsx`, `page.tsx`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ensureSeedData()` connect `google-maps.ts` to `telefonNormalize`, `getSupabaseAdmin`, `mappers.ts`, `ensureSeedData`, `talep-fotograf.ts`, `sms-provider.ts`, `CekiciAyarlarPanel.tsx`, `memnuniyet.ts`, `CekiciRotaPanel.tsx`, `route.ts`, `route.ts`, `seed.ts`, `smsBaseUrl`, `route.ts`, `page.tsx`?**
...
- **Should `telefonNormalize` be split into smaller, more focused modules?**
  _Cohesion score 0.07595203029665475 - nodes in this community are weakly interconnected._
