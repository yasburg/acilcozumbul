...
## Corpus Check
- 403 files · ~397,538 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1691 nodes · 5298 edges · 66 communities (58 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5a37e126`
...
Cohesion: 0.15
Nodes (31): POST(), listeDurumuBelirle(), cekiciTalepBolgesineUygunMu(), cekiciMusaitMi(), istanbulGunVeDakika(), saatMetniDakika(), cekiciTalepSorununaUygunMu(), demoTeklifEkle() (+23 more)

### Community 2 - "cekici-email-otp.ts"
Cohesion: 0.05
Nodes (105): POST(), POST(), POST(), POST(), IZINLI, POST(), GET(), POST() (+97 more)
...
### Community 4 - "seo.ts"
Cohesion: 0.17
Nodes (29): GET(), rotaKoordinatlari(), toOzet(), GET(), GET(), POST(), GET(), BekleIcerik() (+21 more)
...
Cohesion: 0.06
Nodes (24): SmsKaydi, DegerlendirmeSatir, Ozet, BOS_FORM, KampanyaSatir, KullanimSatir, Ozet, Ozet (+16 more)

### Community 7 - "ui.tsx"
Cohesion: 0.10
Nodes (36): POST(), GET(), POST(), POST(), GET(), POST(), GET(), POST() (+28 more)
...
Cohesion: 0.24
Nodes (12): POST(), KrediPage(), KREDI_PAKET_TL_LISTESI, KREDI_PAKETLERI, KrediPaket, krediPaketBul(), krediPaketOdenecekTL(), KrediPaketTl (+4 more)

### Community 14 - "memnuniyet.ts"
Cohesion: 0.08
Nodes (52): GET(), PUT(), GET(), POST(), GET(), PATCH(), POST(), KayitIcerik() (+44 more)
...
Cohesion: 0.07
Nodes (52): bolgeOzet(), GET(), PUT(), HaritaNokta, PanelCekiciHarita(), RENK, SehirAdet, cekiciTalepIlIlceyeUygunMu() (+44 more)

### Community 18 - "MusteriAnaSayfa.tsx"
Cohesion: 0.12
Nodes (26): GpsHttpsBanner(), GpsHttpsBannerProps, KonumIzniYardim(), KonumIzniYardimProps, ADIM_OLAYLARI, funnelKaydet(), MusteriAnaSayfa(), Step (+18 more)
...
Cohesion: 0.09
Nodes (46): GET(), GET(), POST(), GET(), POST(), POST(), POST(), GET() (+38 more)

### Community 24 - "page.tsx"
Cohesion: 0.09
Nodes (40): POST(), GET(), baseUrlFrom(), GET(), POST(), anlasilanIsSay(), cekiciPuanOzeti, computePuanFromTables() (+32 more)

### Community 25 - "kredi-odeme.ts"
Cohesion: 0.17
Nodes (20): GET(), POST(), GET(), POST(), panelKullanici(), POST(), netgsmYapilandirildi(), sendPanelTopluSms() (+12 more)
...
Cohesion: 0.10
Nodes (34): GET(), haftaBaslangici(), istanbulAyAnahtari(), kazananTeklifFiyati(), PATCH(), GET(), bugunBaslangicIso(), getTalepler() (+26 more)
...
Cohesion: 0.12
Nodes (30): POST(), panelKullanici(), POST(), register(), belgeBase64Ayikla(), cekiciBelgeYukle(), IZINLI_MIME, uzanti() (+22 more)
...
Cohesion: 0.08
Nodes (34): GET(), GET(), GET(), Saglik, addSmsKaydi(), countSmsLog(), getSmsLog(), getTaleplerSince() (+26 more)
...
Cohesion: 0.06
Nodes (58): GET(), POST(), hataMesajiFromParam(), Ozet, PanelIcerik(), HizmetVerenSayimGostergesi(), HizmetVerenSayimGostergesiProps, useAnimatedNumber() (+50 more)
...
Cohesion: 0.10
Nodes (21): OnayIcerik(), OdemeOnayPage(), KREDI_ODEME_ADIMLARI, ROZET_ODEME_ADIMLARI, Adim, BrandLogoYazili(), MobileShell(), MobileShellProps (+13 more)

### Community 63 - "davet-panel.ts"
Cohesion: 0.16
Nodes (22): GET(), GET(), BOS_FORM, Sablon, GET(), GET(), SMS50_VARYANTLAR, sms50FooterSatirlari() (+14 more)
...
Cohesion: 0.17
Nodes (21): POST(), POST(), KULLANIMA_ACIK_ILLER, sehirBeklemeMesaji(), sehirKullanimAcikMi(), getCekicilerBildirimAdaylari(), updateTalep(), demoKatil() (+13 more)
...
Cohesion: 0.29
Nodes (11): GET(), panelKullanici(), POST(), NETGSM_TR_CIFTE, netgsmSmsBirimHesapla(), netgsmSmsMesajGecerliMi(), netgsmSmsParcaSayisi(), baslatTopluSmsGecmisListe() (+3 more)
...
- **Why does `getSupabaseAdmin()` connect `NasilCalisirSerit.tsx` to `demo-oturum.ts`, `telefonNormalize`, `cekici-email-otp.ts`, `seo.ts`, `mappers.ts`, `ui.tsx`, `CekiciAyarlarPanel.tsx`, `memnuniyet.ts`, `db.ts`, `route.ts`, `davet-panel.ts`, `route.ts`, `page.tsx`, `kredi-odeme.ts`, `route.ts`, `cekici-email-otp.ts`, `demo-responses.ts`, `route.ts`, `CerezOnayBanner.tsx`, `NasilCalisirSerit.tsx`, `davet-panel.ts`, `route.ts`, `route.ts`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `telefonNormalize()` connect `cekici-email-otp.ts` to `demo-oturum.ts`, `NasilCalisirSerit.tsx`, `route.ts`, `google-maps.ts`, `memnuniyet.ts`, `MusteriAnaSayfa.tsx`, `kredi-odeme.ts`, `page.tsx`, `NasilCalisirSerit.tsx`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `Card()` connect `ensureSeedData` to `layout.tsx`, `mappers.ts`, `route.ts`, `route.ts`, `google-maps.ts`, `page.tsx`, `hizmet-veren-sayim.ts`, `MusteriAnaSayfa.tsx`, `ensureSeedData`, `page.tsx`, `CerezOnayBanner.tsx`, `NasilCalisirSerit.tsx`, `page.tsx`, `route.ts`, `kredi-odeme.ts`, `davet-panel.ts`?**
...
- **Should `cekici-email-otp.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.05159883720930233 - nodes in this community are weakly interconnected._
